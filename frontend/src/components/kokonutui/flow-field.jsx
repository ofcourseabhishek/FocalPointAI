...
function fieldAngle(x, y, t) {
  ...
  Math.sin((x + y) * s * 0.6 + t * 0.0009) * Math.PI * 0.6 + Math.cos((x - y) * s * 0.4 + t * 0.0006) * Math.PI * 0.4);
}
  ...
  return (
    <div
      ...
      <motion.h1
        ...
        <br />
        <span
          className="bg-gradient-to-r from-emerald-300 via-teal-200 to-violet-300 bg-clip-text text-transparent">
          own beauty
        </span>
      </motion.h1>
