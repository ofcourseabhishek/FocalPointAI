  ...
  return (
    <div
      ...
      <ChartStatFlow
        ...
        label={defaultLabel}
        labelClassName={cn(chartCenterLabelClassName, "text-[length:var(--chart-foreground-muted)]")}
        prefix={prefix}
        suffix={suffix}
        value={centerValue}
...
export function GaugeLabelLayout({
  ...
  if (placement === "top") {
    return (
      <div
        className={cn("flex w-full min-w-0 flex-col gap-3", crossAxisAlign[align], className)}>
