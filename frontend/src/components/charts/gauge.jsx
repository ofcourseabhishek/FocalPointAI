...
import { defaultChartStatFlowFormat } from "./chart-stat-flow";
import { GaugeLabelLayout, GaugeLabelShell } from "./gauge-label-layout";
import {
...
function GaugeArcInner(props) {
  ...
  const notchTransition = prefersReducedMotion
    ? { duration: 0 }
